# R/fct_load_epa_data.R

#' Load EPA Data for One or More Seasons
#'
#' Retrieves and combines EPA data for the specified `seasons`. Uses cached
...
#'
#' @return A tibble or data.frame with EPA data for the requested seasons.
#'
#' @importFrom nflreadr most_recent_season
#' @export
#' @noRd
load_epa_data <- function(seasons = 2006:most_recent_season()) {
  ...
  get_season_dataset("epa_data", seasons)
}
