# R/fct_load_redzone_data.R

#' Load Red Zone Data for One or More Seasons
#'
#' Retrieves and combines red zone data for the specified `seasons`. Uses cached
...
#'
#' @return A tibble or data.frame with red zone data for the requested seasons.
#'
#' @importFrom nflreadr most_recent_season
#' @export
#' @noRd
load_redzone_data <- function(seasons = 2006:most_recent_season()) {
  ...
  get_season_dataset("redzone_data", seasons)
}
