...
mod_standings_ui <- function(id) {
  tagList(
    ...
    conditionalPanel(
      ...
      # )
      fluidRow(
        column(6, standingsTableOutput("afcReg")),
        column(6, standingsTableOutput("nfcReg"))
      ),
      fluidRow(
        column(6, standingsTableOutput("afcPlayoff")),
        column(6, standingsTableOutput("nfcPlayoff"))
      )
    )
  )
}
