# R/fct_load_season_standings_data.R

#' Load Standings Data for One or More Seasons
#'
#' Retrieves and combines SRS data for the specified `seasons`. Uses cached
...
#'
#' @return A tibble or data.frame with SRS data for the requested seasons.
#'
#' @importFrom nflreadr most_recent_season
#' @export
#' @noRd
load_season_standings_data <- function(seasons = 2006:most_recent_season()) {
  ...
  get_season_dataset("season_standings_data", seasons)
}
