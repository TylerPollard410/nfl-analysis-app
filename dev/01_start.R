...
##
golem::fill_desc(
  pkg_name = "nflanalysisapp", # The name of the golem package containing the app (typically lowercase, no underscore or periods)
  pkg_title = "NFL Analysis Dashboard", # What the Package Does (One Line, Title Case, No Period)
  pkg_description = "Interactive Shiny dashboard for NFL team rankings, historical performance, and Bayesian betting predictions.", # What the package does (one paragraph).
  authors = person(
...
golem::use_favicon(path = "inst/app/www/hex-nflanalysisapp.png") # path = "path/to/ico". Can be an online file.
